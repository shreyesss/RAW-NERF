...
class Config:
  ...
  llffhold: int = 8  # Use every Nth image for the test set. Used only by 
  ...
  train_mode: bool = True # Load LDR jpeg images in the dataloader for metric calculation (False during training)
